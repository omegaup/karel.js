...
var $0 = $$.length - 1;
switch (yystate) {
case 1: return validate($$[$0-5], $$[$0-3].concat([['LINE', yylineno], ['HALT']]), yy); 
break;
case 2: return validate([], $$[$0-3].concat([['LINE', yylineno], ['HALT']]), yy); 
break;
...
case 23: this.$ = $$[$0-1]; 
break;
case 24: this.$ = [['LINE', yylineno], ['LOAD', 0], ['CALL', $$[$0].toLowerCase(), 1], ['LINE', yylineno]]; 
break;
case 25: this.$ = [['LINE', yylineno]].concat($$[$0-1]).concat([['CALL', $$[$0-3].toLowerCase(), 2], ['LINE', yylineno]]); 
break;
