...
break;
case 24:
 this.$ = $$[$0-2].concat($$[$0-4]).concat([['JZ', $$[$0].length]]).concat($$[$0]); 
break;
case 25:
 this.$ = $$[$0-4].concat($$[$0-6]).concat([['JZ', 1 + $$[$0-2].length]]).concat($$[$0-2]).concat([['JMP', $$[$0].length]]).concat($$[$0]); 
break;
case 26:
 this.$ = $$[$0-2].concat($$[$0-4]).concat([['JZ', 1 + $$[$0].length]]).concat($$[$0]).concat([['JMP', -1 -($$[$0-2].length + 1 + $$[$0].length + 1)]]); 
break;
case 27:
 this.$ = $$[$0-2].concat($$[$0-4]).concat([['DUP'], ['LOAD', 0], ['EQ'], ['NOT'], ['JZ', $$[$0].length + 2]]).concat($$[$0]).concat([['DEC'], ['JMP', -1 -($$[$0].length + 7)], ['POP']]); 
break;
case 28:
